...
{
    public class MegaphoneProjectileAlt2 : ModProjectile
    {
        public override string Texture => "arkimedeezMod/Projectiles/MegaphoneProjectile";
        ...
        {
            //Projectile.velocity = Projectile.velocity.RotatedBy((MathHelper.PiOver4) / 20);
