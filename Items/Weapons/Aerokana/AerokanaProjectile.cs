...
namespace arkimedeezMod.Items.Weapons.Aerokana
{
    ...
    public class AerokanaProjectile : ModProjectile
    {
        ...
        private const float SPINRANGE = 5f * (float)Math.PI; // The angle a spin attack covers (630 degrees)
        ...
        private const float SPINTIME = 3f; // How much longer a spin is than a 
        ...
        {
            UnityPlayer.OmegaChargeCurrent = UnityPlayer.OmegaChargeCurrent + 2;
        }
        ...
        public override string Texture => "arkimedeezMod/Items/Weapons/Aerokana/Aerokana"; // Use texture of item as projectile texture
        private Player Owner => Main.player[Projectile.owner];

        public override void SetDefaults()
        {
            Projectile.width = 52; // Hitbox width of projectile
            Projectile.height = 118; // Hitbox height of projectile
