...
{
    public class VenetrationSwingProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.Yellow, Color.OrangeRed, Main.rand.NextFloat() * 0.3f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            UnityPlayer.OmegaChargeCurrent = UnityPlayer.OmegaChargeCurrent + 1.2f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(177, 60, 62); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(178, 105, 25); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(248, 157, 25); // Original Excalibur color: Color(255, 240, 150)
            ...
            Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), Color.OrangeRed * 0.6f * lerpTime, Projectile.rotation + Projectile.ai[0] * 0.01f, origin, scale, spriteEffects, 0f);
            ...
            Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), Color.OrangeRed * 0.4f * lerpTime, Projectile.rotation + Projectile.ai[0] * -0.1f, origin, scale * 0.6f, spriteEffects, 0f);
